...
class Client(fl.client.NumPyClient):
    ...
    def fit(
        ...
        if end-start > 1800.0:
            ...
            torch.save(self.model, "./aggregation_straggler_parameters/late_model_edge%s.pth"%settings.EDGE_NUM)
...
if __name__ == "__main__":
    ...
    straggler_path = "./aggregation_straggler_parameters/"
    initial_path = "./model/"
    
   # os.chmod(straggler_path, 0o777) 
   # os.chmod(initial_path, 0o777)
